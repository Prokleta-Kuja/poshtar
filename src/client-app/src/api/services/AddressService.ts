...
export class AddressService {
   ...
   * @throws ApiError
   */
  public static getAddress({ addressId }: { addressId: number }): CancelablePromise<AddressVM> {
    return __request(OpenAPI, {
      method: 'GET',
   ...
   * @throws ApiError
   */
  public static deleteAddress({ addressId }: { addressId: number }): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: 'DELETE',
      url: '/api/addresses/{addressId}',
      path: {
