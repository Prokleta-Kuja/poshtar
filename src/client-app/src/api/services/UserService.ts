...
export class UserService {
   ...
   * @throws ApiError
   */
  public static createUser({ requestBody }: { requestBody?: UserCM }): CancelablePromise<UserVM> {
    return __request(OpenAPI, {
      method: 'POST',
      url: '/api/users',
      body: requestBody,
   ...
   * @throws ApiError
   */
  public static getUser({ userId }: { userId: number }): CancelablePromise<UserVM> {
    return __request(OpenAPI, {
      method: 'GET',
   ...
   * @throws ApiError
   */
  public static deleteUser({ userId }: { userId: number }): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: 'DELETE',
      url: '/api/users/{userId}',
      path: {
