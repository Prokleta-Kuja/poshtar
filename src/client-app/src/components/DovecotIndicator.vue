...
const exec = (command: ServiceRequestType) => ServicesService.request({
    requestBody: {
        ...
        <template #body>
            <div class="d-flex justify-content-center mb-4">
                <div class="btn-group" role="group">
                    <button type="button" class="btn btn-success" @click="exec(ServiceRequestType.Start)">Start</button>
                    <button type="button" class="btn btn-warning" @click="exec(ServiceRequestType.Restart)">Restart</button>
                    <button type="button" class="btn btn-danger" @click="exec(ServiceRequestType.Stop)">Stop</button>
                </div>
            </div>
