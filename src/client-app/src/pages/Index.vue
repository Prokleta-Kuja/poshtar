        ...
        <table class="table table-sm">
            ...
            <tbody>
                <tr v-for="item in data.items" :key="item.id" class="align-middle">
                    ...
                    <td class="user-select-all text-nowrap">{{ item.client }}</td>
                    <td>
                        <svg v-if="item.username" :title="item.username" xmlns="http://www.w3.org/2000/svg" width="16"
                            height="16" fill="currentColor" class="bi bi-person-badge-fill me-2" viewBox="0 0 16 16">
                            <path
                        ...
                        <span class="user-select-all text-nowrap">{{ item.from }}</span>
                    </td>
