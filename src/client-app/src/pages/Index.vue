    ...
    <div class="table-responsive">
        <table class="table table-sm">
            <thead>
                ...
                <Header :params="data.params" :on-sort="refresh" column="country" />
                <Header :params="data.params" :on-sort="refresh" column="ipAddress" display="IP" />
            ...
            <tbody>
                <tr v-for="item in data.items" :key="item.id" class="align-middle">
                    ...
                    <td>
                        <span v-if="item.country === 'XX'" title="Local Area Network">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <span v-else-if="item.country === 'ZZ'" title="Monitoring">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <td class="user-select-all">{{ item.ipAddress }}</td>
                    <td class="user-select-all">{{ item.client }}</td>
                    <td>
                        <span class="user-select-all">{{ item.from }}</span>
