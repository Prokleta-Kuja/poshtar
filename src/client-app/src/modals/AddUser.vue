...
import { UserCM, UserService } from '../api';
    ...
    <Modal title="Add user" :shown="shown" :onClose="toggle">
        <template #body>
            <form @submit.prevent="submit">
                ...
                <Text class="mb-3" label="Password" :autoComplete="'off'" :type="'password'" v-model="user.model.password"
        ...
        <template #footer>
            ...
            <SpinButton class="btn-primary" :loading="user.submitting" text="Add" loadingText="Adding" @click="submit" />
        </template>
    </Modal>
</template>